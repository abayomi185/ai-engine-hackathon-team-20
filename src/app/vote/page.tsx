...
export default function VoterPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-purple-600 via-pink-600 to-blue-600 p-4">
            ...
            <div className="space-y-4 text-center">
              ...
              <div className="space-y-2">
                {Object.entries(votes).map(([prompt, count]) => (
                  <div
                    key={prompt}
                    className="flex items-center justify-between rounded-lg bg-white/20 p-2"
                  >
                    <span>{prompt}</span>
